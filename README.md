...
2. SenseAir CO2 using S8 CO2 sensor (CO2meter.com), its 5v supply taken from RPi zero. CO2_mm.py shows min & max CO2 levels over a 12h time period. Example CO2_mm_jpg is overnight readings in a bedroom,
