...
# Change  line 31 /dev/ttyS0 to dev/ttyUSB0
...
def graph(cpm):
    ...
    ax.set_ylabel('Radiation (cpm)', fontsize = 12)
    ax.set_ylim(0,50)
    ax.set_xlabel('Time',fontsize = 12)
    ax.set_title(f' Approximate dose: {usv} uSv/Hr. File name: {filename}',fontsize = 11)
