...
# add to end of file:
# @sudo /usr/bin/python3 /home/pi/temp_co2.py &
import bme680
import os.path
import csv
...
if os.path.exists('/home/pi/Desktop/temp_co2.csv'):
    filename = '/home/pi/Desktop/temp_co2.csv'
...
# Format graph   
    ...
    fig.suptitle(f'Air Temperature, {temp} \u00B0C and Carbon dioxide, {co2} ppm, \n  Updated: {nowtime}, Sleep time = {nap} min, file = /home/pi/Desktop/temp_hum.csv',fontsize = 12,fontweight='bold')
    ax1.set_title(f'Temp max {htemp} \u00B0C at {htime_temp}: Temp min {ltemp} \u00B0C at {ltime_temp} \n CO\u2082 max {hco2} % at {htime_co2}, CO\u2082 min {lco2} % at {ltime_co2}')   
